    ...
    components: {
        ...
        changePassword: {
            ...
            modals: {
                confirmationModal: {
                    ...
                    message:
                        "உங்கள் கடவுச்சொல்லை புதுப்பிப்பதால் அனைத்து பயன்பாடுகளிலிருந்தும் நீங்கள் " +
                        "வெளியேற்றப்படலாம். வெளியேற்றப்பட்டால், உங்கள் புதிய கடவுச்சொல்லைப் பயன்படுத்தி " +
                        "மீண்டும் உள்நுழையவும். தொடர விரும்புகிறீர்களா?"
                }
            }
        },
        consentManagement: {
            ...
            authenticatorApp: {
                ...
                modals: {
                    ...
                    scan: {
                        ...
                        manualEntryLabel: "குறியீட்டை கைமுறையாக உள்ளிடவும்",
                        ...
                        showSecretKey: "ரகசியத்தைக் காட்டு"
                    },
        ...
        profile: {
            ...
            messages: {
                ...
                emailVerification: {
                    content: "இரண்டாம் கட்ட அங்கீகாரம் செயல்படுத்தப்பட்டிருக்கும்போது சரிபார்ப்பு மின்னஞ்சல்களை அனுப்பவும், பயனர்பெயர்/கடவுச்சொல் மீட்பின் போது மீட்பு குறியீடுகளை அனுப்பவும் இந்த மின்னஞ்சல் முகவரி பயன்படுத்தப்படுகிறது. இந்த மின்னஞ்சலை புதுப்பிக்க, உங்கள் புதிய மின்னஞ்சலுக்கு அனுப்பப்பட்ட சரிபார்ப்பு குறியீட்டை உள்ளிட்டு புதிய மின்னஞ்சலை சரிபார்க்க வேண்டும். தொடர விரும்பினால் புதுப்பி என்பதைக் கிளிக் செய்யவும்."
                },
                mobileVerification: {
        ...
        verificationOnUpdate: {
            modal: {
                common: {
                    step2: {
                        hint: "குறியீடு கிடைக்கவில்லையா?",
                        resend: "மீண்டும் அனுப்பு",
                        resendSuccess: "குறியீட்டை மீண்டும் அனுப்பும் கோரிக்கை வெற்றிகரமாக அனுப்பப்பட்டது",
                        validation: {
                            otpRequired: "சரிபார்ப்பு குறியீட்டை உள்ளிடவும்"
                        },
                        verificationFailure: "சரிபார்ப்பு தோல்வியடைந்தது. மீண்டும் முயற்சிக்கவும்."
                    }
                },
                email: {
                    step1: {
                        content: {
                            label: "உங்கள் புதிய மின்னஞ்சல் முகவரியை உள்ளிடவும்"
                        },
                        heading: "உங்கள் மின்னஞ்சல் முகவரியை சரிபார்க்கவும்",
                        validation: {
                            invalidFormat: "செல்லுபடியாகும் மின்னஞ்சல் முகவரியை உள்ளிடவும்",
                            required: "மின்னஞ்சல் முகவரி அவசியம்"
                        }
                    },
                    step2: {
                        content: {
                            label: "ஒரு சரிபார்ப்பு குறியீடு உங்கள் மின்னஞ்சலுக்கு அனுப்பப்பட்டுள்ளது. உங்கள் மின்னஞ்சல் முகவரியை சரிபார்க்க கீழே உள்ள குறியீட்டை உள்ளிடவும்."
                        },
                        heading: "உங்கள் மின்னஞ்சல் முகவரியை சரிபார்க்கவும்"
                    },
                    step3: {
                        content: "வெற்றி! உங்கள் மின்னஞ்சல் முகவரி வெற்றிகரமாக சரிபார்க்கப்பட்டது."
                    }
                },
                notifications: {
                    resendError: {
                        description: "சரிபார்ப்பு குறியீட்டை மீண்டும் அனுப்பும்போது பிழை ஏற்பட்டது",
                ...
                sms: {
                    step1: {
                        content: {
                            label: "உங்கள் புதிய கைபேசி எண்ணை உள்ளிடவும்"
                        },
                        heading: "உங்கள் கைபேசி எண்ணை சரிபார்க்கவும்",
                        validation: {
                            invalidFormat: "செல்லுபடியாகும் கைபேசி எண்ணை உள்ளிடவும்",
                            required: "கைபேசி எண் அவசியம்"
                        }
                    },
                    step2: {
                        content: {
                            label: "ஒரு சரிபார்ப்பு குறியீடு உங்கள் கைபேசி எண்ணுக்கு அனுப்பப்பட்டுள்ளது. உங்கள் கைபேசி எண்ணை சரிபார்க்க கீழே உள்ள குறியீட்டை உள்ளிடவும்."
                        },
                        heading: "உங்கள் கைபேசி எண்ணை சரிபார்க்கவும்"
                    },
                    step3: {
                        content: "வெற்றி! உங்கள் கைபேசி எண் வெற்றிகரமாக சரிபார்க்கப்பட்டது."
                    }
                }
            },
            preference: {
