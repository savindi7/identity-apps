        ...
        changePassword: {
            ...
            modals: {
                confirmationModal: {
                    ...
                    message:
                        "ඔබගේ සංවිධානයේ ආරක්ෂක සැකසීම් අනුව මුරපදය වෙනස් කිරීමෙන් " +
                        "ඔබගේ වත්මන් සැසිය බලපෑමට ලක් විය හැකිය. ඔබ ලොග් අවුට් වී ඇත්නම්, " +
                        "ඔබේ නව මුරපදය භාවිතා කර නැවත ප්‍රවේශ වන්න. ඉදිරියට යාමට ඔබ කැමතිද?"
                }
            }
        },
        consentManagement: {
