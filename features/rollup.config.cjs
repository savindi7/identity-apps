...
module.exports = [
    {
        ...
        input: [
            ...
            "./admin.sms-templates.v1/public-api.ts",
            "./admin.template-core.v1/public-api.ts",
            ...
            generatePackageJson({
                baseContents: (pkg) => ({
                    ...
                    exports: {
                        ...
                        "./admin.sms-templates.v1": "./admin.sms-templates.v1/public-api.js",
                        "./admin.template-core.v1": "./admin.template-core.v1/public-api.js",
